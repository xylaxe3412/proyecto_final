    ...
    public function run(): void
    {
        $suggestions = [
            ...
            [
                ...
                'icon' => '<lottie-player src="/animations/run.json" background="transparent" speed="1" style="width: 40px; height: 40px;" loop autoplay></lottie-player>',
                'categoria' => 'salud',
                'popularity' => 150,
            ...
            [
                ...
                'icon' => '<lottie-player src="/animations/water.json" background="transparent" speed="1" style="width: 40px; height: 40px;" loop autoplay></lottie-player>',
                'categoria' => 'salud',
                'popularity' => 200,
            ...
            [
                ...
                'icon' => '<lottie-player src="/animations/productivity.json" background="transparent" speed="1" style="width: 40px; height: 40px;" loop autoplay></lottie-player>',
            ...
            [
                ...
                'icon' => '<lottie-player src="/animations/wellbeing.json" background="transparent" speed="1" style="width: 40px; height: 40px;" loop autoplay></lottie-player>',
                'categoria' => 'bienestar',
                'popularity' => 120,
                'frequency_suggestions' => ['diario'],
            ...
            [
                ...
                'icon' => '<lottie-player src="/animations/learning.json" background="transparent" speed="1" style="width: 40px; height: 40px;" loop autoplay></lottie-player>',
