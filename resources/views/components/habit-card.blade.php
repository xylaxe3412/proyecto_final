<div class="habit-card bg-gray-50 dark:bg-white/10 rounded-2xl p-8 border border-gray-200 dark:border-white/20 cursor-pointer 
           hover:border-motiveo-primary/50 transition-all duration-500 mb-6 transform hover:scale-105 
           hover:-translate-y-2 hover:shadow-xl hover:shadow-blue-500/10 dark:hover:shadow-motiveo-primary/20 animate-card-appear group
           hover:bg-white dark:hover:bg-white/15 animate-float-delayed backdrop-blur-sm"
    ...
    <div class="flex items-start justify-between mb-6">
        <div class="flex items-center space-x-3">
            ...
            <div class="transform group-hover:translate-x-1 transition-transform duration-300">
                <h3 class="text-gray-900 dark:text-white font-bold text-lg group-hover:text-motiveo-accent transition-colors duration-300" 
                    x-text="habit.nombre"></h3>
                <p class="text-gray-700 dark:text-white/60 text-sm capitalize animate-text-shimmer" x-text="habit.categoria"></p>
            </div>
        </div>
        <!-- Estado visual -->
        ...
        <span class="text-xs text-gray-500 dark:text-white/60 group-hover:text-gray-700 dark:group-hover:text-white/80 transition-colors duration-300" 
            x-text="habit.is_completed ? 'Completado' : 'Pendiente'"></span>
        </div>
    </div>
    <!-- Descripción breve -->
     <p class="text-gray-800 dark:text-white/80 text-sm mb-6 line-clamp-2 group-hover:text-gray-900 dark:group-hover:text-white transition-colors duration-300" 
    ...
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex items-center text-xs text-gray-700 dark:text-white/60 group-hover:text-gray-900 dark:group-hover:text-white/80 transition-colors duration-300">
