            ...
            <div class="max-w-md w-full space-y-8">
                ...
                <form class="mt-8 space-y-6" action="{{ route('login') }}" method="POST">
                    ...
                    <a 
                        ...
                        class="w-full flex justify-center items-center py-4 px-4 border-2 border-gray-200 rounded-xl shadow-lg text-base font-bold text-gray-700 bg-white hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 transition-all duration-200 transform hover:scale-105"
                    >
